...
def parse_patterns(ctx):
    ...
    patterns
        = [ pattern ] { "," pattern } [ "," ]
    """
    patterns = parse_many_separated_by(parse_pattern, parse_value(","))(ctx)
    if patterns:
...
def parse_expressions(ctx):
    ...
    expressions
        = [ expression ] { "," expression } [ "," ]
    """
    return parse_many_separated_by(parse_expression, parse_value(","))(ctx)
...
def parse_pairs(ctx):
    ...
    pairs
        = [ pair ] { "," pair } [ "," ]
    """
    return parse_many_separated_by(parse_pair, parse_value(","))(ctx)
...
def parse_cases(ctx):
    ...
    cases
        = [ case ] { "," case } [ "," ]
    """
    return parse_many_separated_by(parse_case, parse_value(","))(ctx)